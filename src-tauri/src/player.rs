...
impl Player {
    pub fn new() -> Self {
        ...
        let pipeline = gstreamer::parse_launch(
            "uridecodebin name=uridecodebin ! audioconvert name=audioconvert ! tee name=t ! queue ! audioresample ! volume name=volume ! autoaudiosink t. ! queue ! spectrum bands=128 threshold=-60 interval=50000000 ! fakesink",
        )
